...
# Groupp by assister_id_fixed and gets number of rows as assists as each assister_id even is an assist.
...
scoreboard = scoreboard[['player_id_fixed','kills','deaths','assists','K/D Ratio','longest kill distance']]
